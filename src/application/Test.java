...
import javafx.scene.layout.StackPack;
import javafx.stage.Stage;

public class Test extends Application implements EventHandler<ActionEven>{
    public static void main(String[] args){
    	...
    	*/
    	...
    	Collections.addAll(yogaSchedIndex,monday, tuesday, wednesday);
